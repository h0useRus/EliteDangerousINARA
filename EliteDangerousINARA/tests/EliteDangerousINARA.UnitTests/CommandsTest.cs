...
namespace NSW.EliteDangerous.INARA
{
    public class CommandsTest : IClassFixture<InaraCommandFixture>
    {
        ...
        public void FindCommanderProfile()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"getCommanderProfile\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"searchName\":\"Vasya Pupkin\"}}]}", json);
        }
        ...
        public void AddCommanderPermit()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"addCommanderPermit\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"starsystemName\":\"Sol\"}}]}", json);
        }
        ...
        public void SetCommanderCredits()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"setCommanderCredits\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"commanderCredits\":1000}}]}", json);

            json = _fixture.INARA.AddCommand(new SetCommanderCredits(1000) { Assets = 50, Loan = 20 }).GetJson();
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"setCommanderCredits\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"commanderCredits\":1000,\"commanderAssets\":50,\"commanderLoan\":20}}]}", json);
        }
        ...
        public void SetCommanderRankEngineer()
        {
            var json = _fixture.INARA
                ...
                .GetJson();
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"setCommanderRankEngineer\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":[{\"engineerName\":\"Elvira Martuuk\",\"rankStage\":\"Unlocked\",\"rankValue\":4},{\"engineerName\":\"Liz Ryder\",\"rankStage\":\"Unlocked\",\"rankValue\":2}]}]}", json);
        }
        ...
        public void SetCommanderRankPilot()
        {
            var json = _fixture.INARA
                ...
                .GetJson();
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"setCommanderRankPilot\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"rankName\":\"combat\",\"rankValue\":4}}]}", json);
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"setCommanderRankPilot\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":[{\"rankName\":\"combat\",\"rankValue\":4},{\"rankName\":\"trade\",\"rankValue\":2,\"rankProgress\":0.31}]}]}", json);
        }
        ...
        public void SetCommanderRankPower()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"setCommanderRankPower\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"powerName\":\"Felicia Winters\",\"rankValue\":2}}]}", json);
        }
        ...
        public void SetCommanderReputationMajorFaction()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"setCommanderReputationMajorFaction\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"majorfactionName\":\"empire\",\"majorfactionReputation\":0.84}}]}", json);
            ...
            json = _fixture.INARA
                ...
                .GetJson();
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"setCommanderReputationMajorFaction\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":[{\"majorfactionName\":\"empire\",\"majorfactionReputation\":0.84},{\"majorfactionName\":\"federation\",\"majorfactionReputation\":0.36}]}]}", json);
        }
        ...
        public void SetCommanderReputationMinorFaction()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"setCommanderReputationMinorFaction\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"minorfactionName\":\"Inara Nexus\",\"minorfactionReputation\":0.76}}]}", json);
        ...
        public void AddCommanderInventoryCargoItem()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"addCommanderInventoryCargoItem\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"itemName\":\"conductivefabrics\",\"itemCount\":3}}]}", json);

            json = _fixture.INARA.AddCommand(new AddCommanderInventoryCargoItem("conductivefabrics", 3) { IsStolen = true }).GetJson();
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"addCommanderInventoryCargoItem\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"itemName\":\"conductivefabrics\",\"itemCount\":3,\"isStolen\":true}}]}", json);
        ...
        public void RemoveCommanderInventoryCargoItem()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"delCommanderInventoryCargoItem\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"itemName\":\"conductivefabrics\",\"itemCount\":3}}]}", json);

            json = _fixture.INARA.AddCommand(new RemoveCommanderInventoryCargoItem("conductivefabrics", 3) { IsStolen = true }).GetJson();
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"delCommanderInventoryCargoItem\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"itemName\":\"conductivefabrics\",\"itemCount\":3,\"isStolen\":true}}]}", json);
        ...
        public void SetCommanderInventoryCargoItem()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"setCommanderInventoryCargoItem\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"itemName\":\"cobalt\",\"itemCount\":11,\"missionGameID\":170577201}}]}", json);
        }
        ...
        public void RemoveCommanderInventoryMaterialsItem()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"delCommanderInventoryMaterialsItem\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"itemName\":\"nickel\",\"itemCount\":2}}]}", json);
        }
        ...
        public void SetCommanderInventoryMaterials()
        {
            var json = _fixture.INARA
                ...
                .GetJson();
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"setCommanderInventoryMaterials\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":[{\"itemName\":\"phosphorus\",\"itemCount\":30},{\"itemName\":\"nickel\",\"itemCount\":10},{\"itemName\":\"crystalshards\",\"itemCount\":20}]}]}", json);
        }
        ...
        public void SetCommanderInventoryMaterialsItem()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"setCommanderInventoryMaterialsItem\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"itemName\":\"crystalshards\",\"itemCount\":15}}]}", json);
        }
        ...
        public void AddCommanderShip()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"addCommanderShip\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"shipType\":\"Sidewinder\",\"shipGameID\":7}}]}", json);
        }
        ...
        public void RemoveCommanderShip()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"delCommanderShip\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"shipType\":\"Sidewinder\",\"shipGameID\":7}}]}", json);
        }
        ...
        public void SetCommanderShipTransfer()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"setCommanderShipTransfer\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"shipType\":\"Sidewinder\",\"shipGameID\":7,\"starsystemName\":\"Sol\",\"stationName\":\"Abraham Lincoln\",\"transferTime\":643}}]}", json);
        }
        ...
        public void AddCommanderTravelDock()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"addCommanderTravelDock\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"starsystemName\":\"Kokatese\",\"stationName\":\"Koontz Enterprise\",\"shipType\":\"Sidewinder\",\"shipGameID\":2}}]}", json);
        }
        ...
        public void AddCommanderTravelFsdJump()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"addCommanderTravelFSDJump\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"starsystemName\":\"Kokatese\",\"jumpDistance\":10.28,\"shipType\":\"Sidewinder\",\"shipGameID\":2}}]}", json);
        }
        ...
        public void SetCommanderMissionAbandoned()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"setCommanderMissionAbandoned\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"missionGameID\":171735583}}]}", json);
        }
        ...
        public void SetCommanderMissionFailed()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"setCommanderMissionFailed\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"missionGameID\":171735583}}]}", json);
        }
        ...
        public void AddCommanderCombatInterdicted()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"addCommanderCombatInterdicted\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"starsystemName\":\"Lave\",\"opponentName\":\"White Rabbit Revenger\",\"isPlayer\":true,\"isSubmit\":true}}]}", json);
        }
        ...
        public void AddCommanderCombatInterdiction()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"addCommanderCombatInterdiction\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"starsystemName\":\"Lave\",\"opponentName\":\"Mad White Rabbit\",\"isPlayer\":true,\"isSuccess\":true}}]}", json);
        }
        ...
        public void AddCommanderCombatInterdictionEscape()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"addCommanderCombatInterdictionEscape\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"starsystemName\":\"Lave\",\"opponentName\":\"White Rabbit Revenger\",\"isPlayer\":true}}]}", json);
        }
        ...
        public void AddCommanderCombatKill()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"addCommanderCombatKill\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"starsystemName\":\"Lave\",\"opponentName\":\"Cmdr White Rabbit Revenger\"}}]}", json);
        }
        ...
        public void GetCommunityGoalsRecent()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"getCommunityGoalsRecent\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{}}]}", json);
        }
        ...
        public void SetCommanderCommunityGoalProgress()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"setCommanderCommunityGoalProgress\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"communitygoalGameID\":428,\"contribution\":123500,\"percentileBand\":75,\"percentileBandReward\":600000,\"isTopRank\":false}}]}", json);
        }
        ...
        public void SetCommunityGoal()
        {
            ...
            Assert.Equal("{\"header\":{\"appName\":\"your_application_name\",\"appVersion\":\"1.2.3\",\"isDeveloped\":true,\"APIkey\":\"your_apikey_from_inara\",\"commanderName\":\"Your Commander\",\"commanderFrontierID\":\"F1234567\"},\"events\":[{\"eventName\":\"setCommunityGoal\",\"eventTimestamp\":\"2019-09-02T17:00:00Z\",\"eventData\":{\"communitygoalGameID\":428,\"communitygoalName\":\"Conflict in Colonia - Colonia Council\",\"starsystemName\":\"Colonia\",\"stationName\":\"Jaques Station\",\"goalExpiry\":\"2017-10-29T18:00:00Z\",\"tierReached\":2,\"tierMax\":8,\"topRankSize\":10,\"isCompleted\":false,\"contributorsNum\":1458,\"contributionsTotal\":1568756}}]}", json);
        }
    }
}